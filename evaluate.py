        ...
        for subset_name in args.subset:
            ...
            with open(output_file, 'w') as f:
                ...
                for iou_threshold in iou_thresholds:
                    line = f"AP@{iou_threshold} Score for {modality} modality in {subset_name} set: {ap_score[iou_threshold]}"
                    print(line, file=f)
                print("--------------------------------------------------", file=f)
                ...
                for n_proposals in n_proposals_list:
                    line = f"AR@{n_proposals} Score for {modality} modality in {subset_name} set: {ar_score[n_proposals]}"
                    print(line, file=f)
                print("--------------------------------------------------", file=f)
