...
class MaskedBsnppLoss(Module):
    ...
    # fusion_bm_map_p(look), fusion_bm_map_c(look), fusion_bm_map_p_c(look), fusion_cbg_start, fusion_cbg_end,
    # fusion_cbg_start_back, fusion_cbg_end_back, fusion_bm_label(look), fusion_start_label, fusion_end_label, n_frames
